...
const uiT = {
  en: {
    ...
    address_placeholder: "e.g. 52 Montague Drive",
    suburb_label: "Suburb *",
    suburb_placeholder: "e.g. Montague Gardens",
  ...
  af: {
    ...
    address_placeholder: "b.v. Montague-rylaan 52",
    suburb_label: "Voorstad *",
    suburb_placeholder: "b.v. Montague Gardens",
